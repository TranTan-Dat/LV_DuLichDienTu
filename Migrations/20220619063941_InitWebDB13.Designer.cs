...
namespace LV_DuLichDienTu.Migrations
{
    ...
    [Migration("20220619063941_InitWebDB13")]
    partial class InitWebDB13
    {
            ...
            modelBuilder.Entity("LV_DuLichDienTu.Models.DiaDiem_DuLich", b =>
                {
                    ...
                    b.Property<string>("dddl_quanhuyen")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LV_DuLichDienTu.Models.DichVu", b =>
                {
                    ...
                    b.Property<double>("dv_trungbinhchatluong")
                        .HasColumnType("float");
